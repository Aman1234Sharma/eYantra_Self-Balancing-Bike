...
#x_1=[];
#x_2=[];
solution=solve([x1_dot==0,x2_dot==0],[x1,x2]);
for i=1:length(solution)
  x_1=[x_1;solution{i}.x1];
  x_2=[x_2;solution{i}.x2];
...
function jacobian_matrices = find_jacobian_matrices(x_1, x_2, x1_dot, x2_dot)
  ...
  jacobian_matrices = {};
  ################## ADD YOUR CODE HERE ######################
  jaco = jacobian([x1_dot;x2_dot],[x1;x2]);
  for i=1:length(solutions)
    matrice = subs(jaco,[x1,x2],[solutions(i, 1), solutions(i, 2)]);
    jacobian_matrices{i}=double(matrice);
  endfor
